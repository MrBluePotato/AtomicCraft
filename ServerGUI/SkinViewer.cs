    ...
    public partial class SkinViewer : Form
    {
        ...
        private void SetPlayerInfoText(PlayerInfo info)
        {
            ...
            if (!info.LastIP.Equals(System.Net.IPAddress.None))
            {
                ...
                {
                    textBox1.Text +=
                        String.Format("  Built {0} and deleted {1} blocks, drew {2}M blocks, wrote {3} messages.\r\n",
                            info.BlocksBuilt,
                            info.BlocksDeleted,
                ...
                {
                    textBox1.Text +=
                        String.Format("  Built {0} and deleted {1} blocks, drew {2}K blocks, wrote {3} messages.\r\n",
                            info.BlocksBuilt,
                            info.BlocksDeleted,
                ...
                {
                    textBox1.Text +=
                        String.Format("  Built {0} and deleted {1} blocks, drew {2} blocks, wrote {3} messages.\r\n",
                            info.BlocksBuilt,
                            info.BlocksDeleted,
                            info.BlocksDrawn,
                            info.MessagesWritten);
        ...
        private void GetSetSkin()
        {
            ...
            CopyRegionIntoImage(webSkin as Bitmap, new Rectangle(20, 20, 8, 12), temp, new Rectangle(4, 8, 8, 12));
                //body
            CopyRegionIntoImage(webSkin as Bitmap, new Rectangle(0, 20, 4, 12), temp, new Rectangle(4, 20, 4, 12));
                //left leg
            CopyRegionIntoImage(webSkin as Bitmap, new Rectangle(12, 20, 4, 12), temp, new Rectangle(8, 20, 4, 12));
                //right leg
            CopyRegionIntoImage(webSkin as Bitmap, new Rectangle(40, 20, 4, 12), temp, new Rectangle(0, 8, 4, 12));
                //left arm
            CopyRegionIntoImage(webSkin as Bitmap, new Rectangle(52, 20, 4, 12), temp, new Rectangle(12, 8, 4, 12));
                //right arm

            //make picturebox the size of the head
            pictureBox1.Image = new Bitmap(8, 8);
            CopyRegionIntoImage(webSkin as Bitmap, head, pictureBox1.Image as Bitmap, new Rectangle(0, 0, 8, 8));
                //copy over the head
            CopyRegionIntoImage(webSkin as Bitmap, headOverlay, pictureBox1.Image as Bitmap, new Rectangle(0, 0, 8, 8));
                //and overlay
        ...
        private static void CopyRegionIntoImage(Bitmap srcBitmap, Rectangle srcRegion, Bitmap destBitmap,
