...
namespace fCraft.ServerGUI
{
    public sealed partial class MainForm : Form
    {
        ...
        private volatile bool shutdownComplete;
        private volatile bool shutdownPending, startupComplete;
            ...
            if (updaterMode != UpdaterMode.Disabled)
            {
                ...
                if (Updater.UpdateCheck())
                {
                    if (updaterMode == UpdaterMode.Notify)
                    {
                        String updateMsg =
                            String.Format(
                                "An AtomicCraft update is available! Visit http://github.com/MrBluePotato/AtomicCraft/downloads to download. " +
