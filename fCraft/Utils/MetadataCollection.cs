...
namespace fCraft
{
    ...
    /// <summary>
    ///     A collection of metadata entries, addressable by pairs of string group/key names.
    ...
    {
        private readonly Dictionary<string, Dictionary<string, TValue>> store =
        ...
        /// <summary>
        ///     Gets or sets the value of a given entry.
