...
namespace fCraft
{
    ...
    public sealed class LogRecorder : IDisposable
    {
        ...
        /// <param name="restrictToThisThread">
        ///     Whether this log recorder should limit
        ///     recording to messages emitted from the same thread that created this object.
        /// </param>
        ...
        /// <summary>
        ///     Stops recording the messages (cannot be resumed).
        ///     This method should be called when you are done with the object.
        ///     If LogRecorder is in a using() block, this will be done for you.
        /// </summary>
        public void Dispose()
        {
            lock (locker)
