...
namespace fCraft
{
    ...
    public static class Paths
    {
        ...
        public const string DataBackupFileNameFormat = "AtomicCraftData_{0:yyyyMMdd'_'HH'-'mm'-'ss}.zip";
        ...
        public static bool TestDirectory([NotNull] string pathLabel, [NotNull] string path, bool checkForWriteAccess)
        {
            ...
            try
            {
                ...
                {
                    string randomFileName = Path.Combine(info.FullName, "AtomicCraft_write_test_" + Guid.NewGuid());
        ...
        ///     If target file is missing and this option is OFF, TestFile returns true.
        ///     If target file is missing and this option is ON, TestFile tries to create
        ///     a file and returns whether it succeeded.
        /// </param>
        ...
        public static bool Compare([NotNull] string p1, [NotNull] string p2, bool caseSensitive)
        {
            ...
            return
                String.Equals(Path.GetFullPath(p1).TrimEnd(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar),
