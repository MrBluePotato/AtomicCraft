...
namespace fCraft.Drawing
{
    ...
    public abstract class DrawOperation
    {
        ...
        /// <summary>
        ///     Player who is executing this command.
        ///     Used for both permission checks and messaging.
        /// </summary>
        [NotNull] public readonly Player Player;

        /// <summary> Map to draw blocks to. </summary>
        [NotNull] public readonly Map Map;

        /// <summary>
        ///     Brush used to determine which blocks to place.
        ///     Must be assigned before DrawOperation.Prepare() is called.
        /// </summary>
        [NotNull]
        public IBrushInstance Brush { get; set; }

        /// <summary>
        ///     Block change context, to be reported to BlockDB and Player.PlacingBlock/PlacedBlock events.
        ///     Should include BlockChangeContext.Drawn flag.
        /// </summary>
        public BlockChangeContext Context { get; set; }

        /// <summary>
        ///     Marks given by the player to this command. Marks could come from either clicks or /Mark command.
        ///     Set by DrawOperation.Prepare()
        /// </summary>
        ...
        /// <summary>
        ///     Area that bounds the DrawOperation's extent, if possible to estimate in advance.
        ///     Used for logging. Should be assigned, as accurately as possible, before DrawOp finishes.
        /// </summary>
        ...
        /// <summary>
        ///     Number of blocks/coordinates that were supposed to be changed/updated,
        ///     but were left untouched due to permission issues.
        /// </summary>
        public int BlocksDenied { get; protected set; }

        /// <summary>
        ///     Number of blocks/coordinates that were processed, and left untouched: either because the Brush decided to skip it,
        ///     or because map's current block matched the desired blocktype.
        /// </summary>
        public int BlocksSkipped { get; protected set; }

        /// <summary>
        ///     Estimate of total number of blocks that will be processed by this command.
        ///     Should be as accurate as reasonably possible by DrawOperation.Prepare().
        ///     Used for volume permission checks. Must not be negative.
        /// </summary>
        ...
        /// <summary>
        ///     Whether the brush should use alternate block (if available)
        ///     for filling insides of hollow DrawOps. Currently only usable with NormalBrush.
        /// </summary>
        ...
        /// <summary>
        ///     Compact description of this specific draw operation,
        ///     with any instance-specific parameters,
        ///     and the brush's instance description.
        /// </summary>
