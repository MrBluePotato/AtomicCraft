...
namespace fCraft
{
    public sealed class PlayerOpException : Exception
    {
        ...
        internal static void CheckBanReason([CanBeNull] string reason, [NotNull] Player player, PlayerInfo targetInfo,
            bool unban)
        {
            if (player == null) throw new ArgumentNullException("player");
        ...
        internal static void CheckRankChangeReason([CanBeNull] string reason, [NotNull] Player player,
            PlayerInfo targetInfo, bool promoting)
        {
            if (player == null) throw new ArgumentNullException("player");
        ...
        internal static void ThrowCannotTargetSelf([NotNull] Player player, [CanBeNull] PlayerInfo target,
        ...
        internal static void ThrowPermissionLimit([NotNull] Player player, [NotNull] PlayerInfo targetInfo,
            [NotNull] string action, Permission permission)
        {
            if (player == null) throw new ArgumentNullException("player");
            ...
            string colorMsg =
                String.Format("&SCannot {0} {1}&S (ranked {2}&S): you may only {0} players ranked {3}&S and below.",
        ...
        internal static void ThrowPlayerAndIPNotBanned([NotNull] Player player, [NotNull] PlayerInfo targetInfo,
        ...
        internal static void ThrowNoOneToBan([NotNull] Player player, [CanBeNull] PlayerInfo targetInfo,
            [NotNull] IPAddress address)
        {
            if (player == null) throw new ArgumentNullException("player");
            if (address == null) throw new ArgumentNullException("address");
            ...
            else
            {
                ...
                {
                    msg =
                        String.Format("Player {0}, their IP ({1}), and all players who use this IP are already banned.",
                            targetInfo.Name, address);
                    colorMsg =
                        String.Format(
                            "&SPlayer {0}&S, their IP ({1}), and all players who use this IP are already banned.",
                            targetInfo.ClassyName, address);
                }
                else
                {
                    msg = String.Format("Player {0}, their IP, and all players who use this IP are already banned.",
                        targetInfo.Name);
                    colorMsg =
                        String.Format("&SPlayer {0}&S, their IP, and all players who use this IP are already banned.",
                            targetInfo.ClassyName);
                }
            }
            throw new PlayerOpException(player, targetInfo, PlayerOpExceptionCode.NoActionNeeded, msg, colorMsg);
        ...
        internal static void ThrowNoOneToUnban([NotNull] Player player, [CanBeNull] PlayerInfo targetInfo,
            [NotNull] IPAddress address)
        {
            if (player == null) throw new ArgumentNullException("player");
            if (address == null) throw new ArgumentNullException("address");
        ...
        internal static void ThrowPlayerAlreadyBanned([NotNull] Player player, [NotNull] PlayerInfo target,
            [NotNull] string action)
        {
            if (player == null) throw new ArgumentNullException("player");
        ...
        internal static void ThrowPlayerNotBanned([NotNull] Player player, [NotNull] PlayerInfo target,
            [NotNull] string action)
        {
            if (player == null) throw new ArgumentNullException("player");
            if (target == null) throw new ArgumentNullException("target");
        ...
        internal static void ThrowInvalidIP([NotNull] Player player, [CanBeNull] PlayerInfo target,
