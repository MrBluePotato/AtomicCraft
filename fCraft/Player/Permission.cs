...
namespace fCraft
{
    ...
    public enum Permission
    {
        ...
        /// <summary>
        ///     Permission to create a server-wide silence, muting all players, and to voice players while the moderation is
        ///     in affect.
        /// </summary>
        Moderation,
        ...
        /// <summary>Permission to use Economy. </summary>
        Economy,
        ...
        /// <summary>Allows the player to connect or disconnect the server from global chat. </summary>
        ManageGlobalChat,

        /// <summary>Allows the player to start or stop a game. </summary>
        ManageGame,

        /// <summary>Allows the player to fly. </summary>
        Fly,

        /// <summary>Allows the player to massrank. </summary>
        Massrank,
