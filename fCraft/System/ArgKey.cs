namespace fCraft
{
    ...
    {
        /// <summary>
        ///     Working path (directory) that fCraft should use.
        ...
        /// <summary>
        ///     Path (directory) where the map files should be loaded from/saved to.
        ///     If the path is relative, it's computed against the working path.
        /// </summary>
        MapPath,

        /// <summary>
        ///     Path (file) of the configuration file.
        ///     If the path is relative, it's computed against the working path.
        /// </summary>
        Config,

        /// <summary>
        ///     If NoRestart flag is present, fCraft will shutdown instead of restarting.
        ///     Useful if you are using an auto-restart script/process monitor of some sort.
        /// </summary>
        NoRestart,

        /// <summary>
        ///     If ExitOnCrash flag is present, fCraft frontends will exit
