...
namespace fCraft
{
    ...
    /// <summary>
    ///     Static class that handles loading/saving configuration, contains config defaults,
    ...
    public static class Config
    {
        ...
        /// <summary>
        ///     Latest version of config.xml available at the time of building this copy of fCraft.
        ///     Config.xml files saved with this build will have this version number embedded.
        /// </summary>
        ...
        private static readonly Dictionary<ConfigSection, ConfigKey[]> KeySections =
            new Dictionary<ConfigSection, ConfigKey[]>();

        // List of renamed/remapped keys.
        private static readonly Dictionary<string, ConfigKey> LegacyConfigKeys = new Dictionary<string, ConfigKey>();
            // LEGACY
        ...
        public static bool Load(bool skipRankList, bool raiseReloadedEvent)
        {
            ...
            if (fromFile)
            {
                ...
                if (attr != null && Int32.TryParse(attr.Value, out version))
                {
                    ...
                    {
                        Logger.Log(LogType.Warning,
                            "Config.Load: Your config.xml was made for a different version of AtomicCraft / 800craft / fCraft. " +
        ...
        ///     Enum to use for parsing.
        ///     An ArgumentException will be thrown if this is not an enum.
        /// </typeparam>
        ...
        /// <summary>
        ///     Sets value of a given config key.
        ...
        /// <returns>
        ///     True if value is valid and has been assigned.
        ///     False if value is valid, but assignment was cancelled by an event handler/plugin.
        /// </returns>
        public static bool SetValue(this ConfigKey key, object rawValue)
        {
            if (rawValue == null)
            {
                throw new ArgumentNullException("rawValue",
                    key + ": ConfigKey values cannot be null. Use an empty string to indicate unset value.");
            }
        ...
        /// <summary>
        ///     Attempts to set the value of a given config key.
        ///     Check the return value to make sure that the given value was acceptible.
        /// </summary>
        /// <param name="key"> Config key to set. </param>
        /// <param name="rawValue"> Value to assign to the key. If passed object is not a string, rawValue.ToString() is used. </param>
        /// <exception cref="T:System.ArgumentNullException" />
        /// <returns>
        ///     True if value is valid and has been assigned.
        ///     False if value was invalid, or if assignment was cancelled by an event handler/plugin.
        /// </returns>
        ...
        /// <summary>
        ///     Resets the list of ranks to defaults (guest/builder/op/owner).
        ...
        private static XElement DefineDefaultRanks()
        {
            ...
            owner.Add(new XElement(Permission.GiveSelf.ToString()));
            owner.Add(new XElement(Permission.Massrank.ToString()));
            owner.Add(new XElement(Permission.CustomName.ToString()));
            owner.Add(new XElement(Permission.Fly.ToString()));
            owner.Add(new XElement(Permission.ManageGame.ToString()));
            owner.Add(new XElement(Permission.ManageGlobalChat.ToString()));
            ...
            op.Add(new XElement(Permission.ManageEconomy.ToString()));
            op.Add(new XElement(Permission.ManageGame.ToString()));
            op.Add(new XElement(Permission.Fly.ToString()));
            op.Add(new XElement(Permission.CustomName.ToString()));
            permissions.Add(op);
            try
            {
            ...
            builder.Add(new XElement(Permission.Fly.ToString()));
            ...
            guest.Add(new XElement(Permission.Economy.ToString()));
        ...
        /// <summary>
        ///     Occurs when a config key is about to be changed (cancellable).
