...
namespace fCraft
{
    ...
    public sealed class ZoneCollection : ICollection<Zone>, ICollection, ICloneable, INotifiesOnChange
    {
        ...
        /// <returns>
        ///     True if the given zone was found & removed.
        ///     False if this collection did not contain the given zone.
        /// </returns>
        ...
        /// <returns>
        ///     None if no zones affect the coordinate.
        ///     Allow if ALL affecting zones allow the player.
        ///     Deny if ANY affecting zone denies the player.
        /// </returns>
        ...
        /// <param name="player"> Player to check. </param>
        /// <returns>
        ///     First zone to deny the player.
        ///     null if none of the zones deny the player.
        /// </returns>
        [CanBeNull]
        ...
        /// <returns>
        ///     Zone object if it was found.
        ///     null if no Zone with the given name could be found.
        /// </returns>
        [CanBeNull]
