...
namespace fCraft
{
    ...
    public sealed unsafe class BlockDB
    {
        ...
        /// <summary>
        ///     Whether BlockDB was enabled at startup.
        ...
        /// <summary>
        ///     Sets this BlockDB's enabled state to Yes (always on), No (aways off),
        ...
        /// <summary>
        ///     Checks whether this BlockDB is enabled (either automatically or manually).
        ...
        /// <summary>
        ///     If EnabledState is set to Auto, calling this auto-enables / auto-disables
        ...
        /// <summary>
        ///     Acquires and returns an exclusive (write) lock for this BlockDB.
        ...
        /// <summary>
        ///     Acquires and returns a shared (read) lock for this BlockDB.
        ///     Disposing the object returned by this method releases the lock.
        /// </summary>
        ...
        ///     The end of FBDB file is reached prematurely (corrupted file, or outside
        ///     interference).
        /// </exception>
        ...
        /// <summary>
        ///     Traverses the database, newest to oldest entries, processing each entry with the given
        ...
        private const int MinCacheSize = 2*1024,
        ...
        /// <returns>
        ///     Number of entries newer than given age.
        ///     0 if all entries are older than given age.
        ///     -1 if all entries are newer than given age.
        /// </returns>
