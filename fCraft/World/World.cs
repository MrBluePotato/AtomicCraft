...
namespace fCraft
{
    public sealed class World : IClassy
    {
        ...
        /// <summary>
        ///     Whether the world shows up on the /Worlds list.
        ...
        /// <summary>
        ///     Ensures that player name has the correct length (2-16 characters)
        ...
        /// <summary>
        ///     Backup state. Use "Yes" to enable, "No" to disable, and "Auto" to use default settings.
            ...
            get
            {
                switch (backupEnabledState)
                {
                    ...
                    default: //case YesNoAuto.Auto:
                        ...
                        {
                            return String.Format("every {0} (default)",
        ...
        public Block SideBlock = Block.Bedrock;
