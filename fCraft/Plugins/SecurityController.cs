...
namespace fCraft
{
    ...
    public sealed class SecurityController : ICloneable, INotifiesOnChange
    {
        ...
        [CanBeNull] private Rank minRank;
        ...
        /// <summary>
        ///     True if a rank restriction is in effect.
        ...
        /// <summary>
        ///     True if this controller has any restrictions
        ...
        /// <summary>
        ///     Either specially includes a player (if their state
        ...
        /// <summary>
        ///     Either specially excludes a player (if their state
        ...
        /// <param name="verb">
        ///     The action, in past tense, that this
        ///     controller manages (e.g. "accessed" or "modified").
        /// </param>
        ...
        /// <summary>
        ///     Resets all permissions: minimum rank,
