...
namespace fCraft
{
    public class FuncDrawOperationPoints : FuncDrawOperation
    {
        ...
        protected override void DrawFase1(int fval, ref int arg1, ref int arg2, ref int val, int min1, int max1,
            int min2, int max2,
        ...
        protected override void DrawFase2(ref int arg1, ref int arg2, ref int val, int min1, int max1, int min2,
            int max2,
            int minV, int maxV, int maxBlocksToDraw)
        {
        }
