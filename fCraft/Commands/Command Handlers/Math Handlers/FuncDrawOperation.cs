...
namespace fCraft
{
    ...
    public abstract class FuncDrawOperation : DrawOperation
    {
        ...
        private static string[] GetVarArray(ValueAxis axis)
        {
            ...
            throw new ArgumentException("Unknown value axis direction " + axis +
        ...
        protected abstract void DrawFase1(int fval, ref int arg1, ref int arg2, ref int val, int min1, int max1,
            int min2, int max2,
            int minV, int maxV, int maxBlocksToDraw);

        protected abstract void DrawFase2(ref int arg1, ref int arg2, ref int val, int min1, int max1, int min2,
            int max2,
            int minV, int maxV, int maxBlocksToDraw);
