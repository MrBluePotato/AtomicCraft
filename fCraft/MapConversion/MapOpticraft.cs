...
namespace fCraft.MapConversion
{
    ...
    {
        [DataMember] public OpticraftZone[] Zones;
    }


    public sealed class OpticraftZone
    {
        [DataMember] public string[] Builders;
        [DataMember] public string[] Excluded;
    ...
    public sealed class MapOpticraft : IMapConverter
    {
        ...
        private static void LoadZones([NotNull] Map mapFile, [NotNull] OpticraftDataStore dataStore)
        {
            ...
            PlayerInfo conversionPlayer = new PlayerInfo("OpticraftConversion", RankManager.HighestRank, true,
            ...
            foreach (OpticraftZone optiZone in dataStore.Zones)
            {
                ...
                BoundingBox bBox = new BoundingBox(optiZone.X1, optiZone.Y1, optiZone.Z1, optiZone.X2, optiZone.X2,
                    optiZone.Z2);
