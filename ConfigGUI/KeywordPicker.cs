...
namespace fCraft.ConfigGUI
{
    public sealed partial class KeywordPicker : Form
    {
        ...
        private static readonly KeywordInfo[] Keywords = new[]
        {
            ...
            new KeywordInfo("{VERSION}", "AtomicCraft version", "Version of AtomicCraft that this server is running.")
        };
        ...
        private struct KeywordInfo
        {
            ...
            public readonly string Keyword, LongName;
